# AudioSplitter serverless API
The AudioSplitter project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=AudioSplitter -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot-archetype -DarchetypeVersion=1.4 -DgroupId=com.audioSplitter -Dversion=0.0.1 -Dinteractive=false
$ cd AudioSplitter
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "AudioSplitterApi",
                    "OutputKey": "AudioSplitterApi",
